...
NotifyMixin = import_string(settings.GARPIX_NOTIFY_MIXIN) if hasattr(settings, 'GARPIX_NOTIFY_MIXIN') else import_string('garpix_notify.mixins.notify_mixin.NotifyMixin')
